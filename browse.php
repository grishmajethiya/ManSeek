...
<body>
    ...
    <div class="post-wall">
        <div id="post-list">
            ...
            $sqlQuery = "SELECT * FROM posts ORDER BY post_id DESC LIMIT 7";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ?>
                <div class="post-item" id="<?php echo $row['post_id']; ?>" data-scroll>
                    <p class="date"><?php echo date('g:i A m-d-Y', strtotime($row['created_at'])); ?></p>
                    <p class="post-title"><?php echo $row['title']; ?></p>
                    <p><?php echo nl2br($row['content']); ?></p>
                    <div class="comments-btn">
                        <a class="comments-open" href="#comments" onclick="getComments(<?php echo $row['post_id']; ?>)">Comments</a>
                        <a class="add-open" href="#add" onclick="getComments(<?php echo $row['post_id']; ?>)">Add a Comment</a>
                    </div>
                </div>
            <?php
            }
